...
function GameScene.create()
   ...
   --scene:addChild(scene:createLayerMenu())
    scene:addChild(scene:ss())
    return scene
end


function GameScene:ss()
    ...
    layer:addChild(sp)
    sp:getPosition()
    local sp = cc.Sprite:create("l.png")
    sp:setAnchorPoint(0,0)
    sp:setPosition(0,0)
    layer:addChild(sp)
    gameWinSize:getInstance():AlignLeftBottom(sp)
    
    local sp = cc.Sprite:create("l.png")
    sp:setAnchorPoint(1,1)
    sp:setPosition(960,640)
    layer:addChild(sp)
    gameWinSize:getInstance():AlignRightTop(sp)
    
    local sp = cc.Sprite:create("l.png")
    sp:setAnchorPoint(0,1)
    sp:setPosition(0,640)
    layer:addChild(sp)
    gameWinSize:getInstance():AlignLeftTop(sp)
    
    local sp = cc.Sprite:create("l.png")
    sp:setAnchorPoint(1,0)
    sp:setPosition(960,0)
    layer:addChild(sp)
    gameWinSize:getInstance():AlignRightBottom(sp)
    
    local sp = cc.Sprite:create("l.png")
    sp:setAnchorPoint(0,0.5)
    sp:setPosition(0,320)
    layer:addChild(sp)
    gameWinSize:getInstance():AlignLeft(sp)
    
    local sp = cc.Sprite:create("l.png")
    sp:setAnchorPoint(1,0.5)
    sp:setPosition(960,320)
    layer:addChild(sp)
    gameWinSize:getInstance():AlignRight(sp)
    
    local sp = cc.Sprite:create("l.png")
    sp:setAnchorPoint(0.5,1)
    sp:setPosition(480,640)
    layer:addChild(sp)
    gameWinSize:getInstance():AlignTop(sp)
    
    local sp = cc.Sprite:create("l.png")
    sp:setAnchorPoint(0.5,0)
    sp:setPosition(480,0)
    layer:addChild(sp)
    gameWinSize:getInstance():AlignBottom(sp)
